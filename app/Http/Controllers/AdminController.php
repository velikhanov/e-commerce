...
class AdminController extends Controller
{
    ...
    public function user_edit(Request $request){
      ...
      if ($request->hasFile('userimg')){
        Storage::disk('google')->exists('1wbJ21pzL0XZwQBVe0hqbbDhbqoUCc2Eo/16mzW0aoT7fzLyIUws47a618lfFhLc8ii')?Storage::disk('google')->delete('1wbJ21pzL0XZwQBVe0hqbbDhbqoUCc2Eo/16mzW0aoT7fzLyIUws47a618lfFhLc8ii'):NULL;
