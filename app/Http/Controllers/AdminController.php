...
class AdminController extends Controller
{
    ...
    public function user_edit(Request $request){
      ...
      if ($request->hasFile('userimg')){
        Storage::disk('google')->exists('1wbJ21pzL0XZwQBVe0hqbbDhbqoUCc2Eo/img_11619281486.png')?Storage::disk('google')->delete('1wbJ21pzL0XZwQBVe0hqbbDhbqoUCc2Eo/img_11619281486.png'):NULL;
