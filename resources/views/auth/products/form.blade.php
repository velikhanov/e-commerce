            ...
            <div>
                ...
                <div class="input-group row">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          @isset($product)
                            @for ($i=0; $i < is_countable($product->properties) ? count($product->properties): NULL; $i++)
                            <div id="inputFormRow">
                          ...
                          @endfor
                          <input type="hidden" id="icount" value="{{ is_countable($product->properties) ? count($product->properties) : NULL }}">
                        @endisset
                        @empty($product)
