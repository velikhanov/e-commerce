        ...
        >
            <div>
                ...
                <br>
                    ...
                    <br> -->
                <div class="input-group row">
                    <label for="url" class="col-sm-2 col-form-label">Sku: </label>
                    <div class="col-sm-6">
                ...
                <div class="input-group row">
                    ...
                    <option>There doesn't seem to be any category</option>
                    </select>
                    @else
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                        <select name="status" id="status" class="form-control">
                          ...
                          <option value="0" @isset($product) @if($product->status == 0) selected @endif @endisset><span>Out of stock</span></option>
                        </select>
                      </div>
                  </div>
                </div>
