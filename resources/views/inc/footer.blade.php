    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="address">
                    <h3>COMFORT</h3>
                    <p class="mb-4 mt-4">Baku, Azerbaijan</p>
                    <p><strong>Phone:</strong> +(994)12-342-75-39</p>
                    <p><strong>Email:</strong> comfotrinc@gmail.com</p>
                </div>
            </div>
...
<div class="footer-bottom">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="text-center mb-2">&copy; Copyright <strong>COMFORT inc</strong>. All Rights Reserved</p>
            </div>
        </div>
    </div>
</div>
